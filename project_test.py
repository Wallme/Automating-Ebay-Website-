...
#LOGIN TO EBAY WEBSITE....(USING ID LOCATORS MOSTLY SHOULD BE DONE)
    def test_login(self,test_setup):
        ...
        #time.sleep(30)
        driver.find_element(By.ID,'userid').send_keys('venkpras49')
        driver.find_element(By.ID,'signin-continue-btn').click()
        time.sleep(4)
        driver.find_element(By.ID,'pass').send_keys('Venky@156')
...
#NAVIGATE TO THE NEW ADDRESS AND UPDATE NEW ADDRESS....(USING ID LOCATORS MOSTLY SHOULD BE DONE)
        ...
        time.sleep(4)
        driver.find_element(By.ID,'s0-0-17-6-addressLine2-field-addressLine2-field').send_keys('#536, S G Layout, Beside Adarsha College, Kolar')
        time.sleep(4)
        ...
        # sign_in = driver.find_element(By.XPATH,'//b[normalize-space()="Venkatesh"]').click()
